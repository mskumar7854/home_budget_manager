...
class _AddTransactionScreenState extends State<AddTransactionScreen> {
  ...
  final _recurrenceOptions = ["daily", "weekly", "monthly", "yearly"];
  final _paymentOptions = ["Cash", "Card", "UPI", "NetBanking", "Wallet"];
  ...
  Future<void> _saveTransaction() async {
    if (_formKey.currentState!.validate() && _selectedCategory != null) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(
            widget.index == null ? "Transaction Added ✅" : "Transaction Updated ✏️",
          ),
        ),
      );
  ...
  Widget build(BuildContext context) {
    final categories =
        Hive.box<Category>('categories').values.where((c) => c.type == _type).toList();
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Text(
                  widget.index == null ? "Add Transaction" : "Edit Transaction",
                      ...
                      children: [
                        ...
                        if (subcats.isNotEmpty)
                          DropdownButtonFormField<String>(
                            ...
                            items:
                                subcats.map((s) => DropdownMenuItem(value: s, child: Text(s))).toList(),
...
}             // end _AddTransactionScreenState
